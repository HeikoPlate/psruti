...
//
// Soll diese Datei von PSRMIDI übernommen werden, müssen alle
// "hpmfi->" durch "" ersetzt werden. Zusätzlich muss ganz vorn die
// Zeile "XgEffects *SysExEventProt::xg_effects = NULL;" scharf gemacht werden.
//
//////////////////////////////////////////////////////////////////////
...
// XgEffects *SysExEventProt::xg_effects = NULL; Nur für Verwendung in PSRMIDI!
// Zusätzlich müssen für PSRMIDI alle "hpmfi->" durch "" ersetzt werden.
...
//			prot_fmt_text("%i, ",(AdrH&0x0f)+1);
			prot_fmt_text("%i, ",(AdrH&0x0f)==0?10:9);
							...
							case 2:
								{
									CString part = eventstr[7]==0x00?"Right1":
												   ...
												   eventstr[7]==0x10?"Auto":
												   eventstr[7]==0x11?"Multi":
												   "Unknown";
				...
				case 0x51: // f0 43 73 01 51...
					{
						if ((eventstr[4]==0x04)&&
							...
							(eventstr[7]==0x02))
						{
							print_str += (CString)"Harmony Echo ";
							switch (eventstr[8])
							{
							case 0x00:
								{
									...
									case 0x00:
										{
											print_str+=(CString)"Standard Duet";
											break;
										}
									case 0x01:
										{
											print_str+=(CString)"Rock Duet";
											break;
										}

									case 0x02:
										{
											print_str+=(CString)"Country Duet";
											break;
										}
									default:
										{
							...
							case 0x01:
								{
									...
									case 0x00:
										{
											print_str+=(CString)"Standard Trio";
											break;
										}
									case 0x01:
										{
											print_str+=(CString)"Country Trio";
											break;
										}
									default:
										{
							...
							case 0x04:
								{
									...
									case 0x00:
										{
											print_str+=(CString)"4-Way Close1";
											break;
										}
									case 0x01:
										{
											print_str+=(CString)"4-Way Close2";
											break;
										}
									default:
										{
							...
							case 0x09:
								{
									...
									case 0x00:
										{
											print_str+=(CString)"Multi Assign";
											break;
										}
									default:
										{
						...
						} // evenstr[4/5/6/7] = 0x04/0x00/0x00/0x02
